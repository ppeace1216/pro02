			...
			<table class="table">
				<tbody>
					<tr>
						<th>아이디</th>
						<td>
							<input type="text" name="cusId" id="cusId" placeholder="아이디 입력" class="form-control" value="<%=customer.getCusId() %>" readonly required />
						</td>
					</tr>
					<tr>
						<th>비밀번호</th>
...
/* 						String cusPw = "";
						...
						%>
							<input type="text" name="cusPw" id="cusPw" placeholder="비밀번호 입력" value="<%=customer.getCusPw() %>" class="form-control" readonly /><button type="button" class="btn btn-primary" onclick="defaultPass()">비밀번호 초기화</button>
							<input type="hidden" name="changePw" id="changePw" value="no">
						</td>
					</tr>
					<tr>
						<th>고객이름</th>
						<td><input type="text" name="cusName" id="cusName" placeholder="이름 입력" class="form-control" value="<%=customer.getCusName() %>" required /></td>
					</tr>
					<tr>
						<th>주소</th>
						<td>
					...
					<tr>
						<th>전화번호</th>
						<td><input type="tel" name="tel" id="tel" placeholder="전화번호 입력 000-0000-0000" class="form-control" value="<%=customer.getTel() %>" required></td>
					</tr>
					<tr>
						<th>회원 포인트</th>
						<td><input type="number" name="point" id="point" class="form-control" value="<%=customer.getPoint() %>" required></td>
					</tr>
					<tr>
						<th>회원 등급</th>
						<td>
					...
					<tr>
						<th>방문횟수</th>
						<td><input type="number" name="visited" id="visited" class="form-control" value="<%=customer.getVisited() %>" required></td>
					</tr>
				</tbody>
			</table>
			<div class="btn-group">
