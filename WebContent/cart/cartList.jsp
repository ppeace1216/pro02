...
<%
	...
	Product po = (Product) request.getAttribute("pro");
%>
	...
	<div class="row" id="content_row">
		...
		<% } %>
			...
			<table class="table">
				<thead>
					<tr>
						<th>연번</th><th>제품사진</th><th>제품명</th><th>구매 수량</th><th>구매</th>
					</tr>
				</thead>
				<tbody>
				<% if(cartList.size()!=0) { %>
					...
					<tr>
						...
						<td><input type="number" name="buyAmount" id="buyAmount" step="1" min="1" max="<%=po.getAmount() %>" class="form-control" required value="1"></td>
